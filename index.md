...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            Linkdein: <a href="https://www.linkedin.com/in/{{ site.social.linkedin }}">{{ site.social.linkedin }}</a>
        </div>
        <div class="col-md-3">
            Github: <a href="https://github.com/{{ site.social.github }}">{{ site.social.github }}</a>
        </div>
        <div class="col-md-3">
            E-mail: <a href="mailto:{{ site.social.email }}">{{ site.social.email }}</a>
        </div>
        <div class="col-md-3">
            CV: <a href="/attachments/cv/cv.pdf">PDF File</a>
        </div>
    </div>
</div>
